...
let newMessage = console.log(message.replace("are", "cant"));
...
let newMsg = console.log(message.replace("still", ""));
console.log(newMsg);
...
let newMsgg = console.log(message.replace("thinking", "decide"));
console.log(newMsgg);
